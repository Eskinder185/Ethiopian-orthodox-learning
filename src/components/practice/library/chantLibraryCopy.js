...
export const chantLibraryCopy = {
  ...
  heroSubtitle: 'Practice mezmur and werb by form, feast, saint, and how they are used',
  featuredCarouselTitle: 'Featured picks',
  ...
  browseFeaturedIntro:
    'A short curated set to start with. Load more for additional suggestions, or open Results to search and filter the full library.',
